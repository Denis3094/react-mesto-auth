...
function AddPlacePopup({
    ...
    return (
        <PopupWithForm
            ...
            <input value={addPlaceName} onChange={handleChangeAddPlaceName} id="title" type="text"
                   className="popup__input popup__input_type_title"
                   placeholder="Название" name="name" required minLength={2} maxLength={30}/>
            <span id="error-title" className="popup__error"/>
            <input value={addPlaceLink} onChange={handleChangeAddPlaceLink} id="link" type="url"
