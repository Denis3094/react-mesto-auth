...
function Card({card, onCardClick, onCardLike, onCardDelete}) {
    ...
    const cardDeleteButtonClassName = (
        `button cards__button-remove ${isOwn ? 'cards__button-remove_visible' : 'cards__button-remove_hidden'}`
    );
    ...
    return (
        <li className="cards__item" id={card._id}>
            ...
            <img onClick={handleClick} className="cards__img" src={card.link} alt={card.name}/>
